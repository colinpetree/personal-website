...
| Capability reference material | `C:\Users\Colin\src\claude-learning-repo\02-claude-api` | One module per capability (tool use, RAG, prompt eval, MCP, web search, vision, etc.) — read the relevant module before designing a new card's backend |
