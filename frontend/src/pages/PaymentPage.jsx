...
export default function PaymentPage() {
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex items-end gap-3">
              ...
              <div className="relative w-20">
                ...
                <input
                  ...
                  placeholder="0.00"
                  className="w-full rounded-md border border-gray-300 pl-6 pr-2 py-2.5 text-base text-gray-900 placeholder-gray-400 outline-none focus:border-amber-400 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
                />
              </div>
            </div>
            ...
            {!user && (
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="rounded-md border border-gray-300 px-3 py-2 text-base text-gray-900 placeholder-gray-400 outline-none focus:border-amber-400 w-full sm:w-64"
                />
              </div>
            )}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <textarea
                ...
                className="rounded-md border border-gray-300 px-3 py-2 text-base text-gray-900 placeholder-gray-400 outline-none focus:border-amber-400 resize-none"
              />
  ...
  return (
    <main ref={mainRef} className={`mx-auto px-6 pt-10 pb-16 ${config?.payment_page_width === 'narrow' ? 'max-w-[524px]' : (commentsEnabled ? 'max-w-5xl' : 'max-w-md')} ${commentsEnabled ? 'lg:h-[calc(100vh-4rem-1px)] lg:overflow-hidden lg:flex lg:flex-col' : ''}`}>
