...
import { ImageNode, VideoNode, AudioNode, FileNode, GalleryNode, DividerNode, CalloutNode, ButtonNode } from './nodes'
import {
  LoadHtmlPlugin,
  HtmlOutputPlugin,
...
const RichTextEditor = forwardRef(function RichTextEditor(
  ...
  const initialConfig = {
    ...
    theme,
    nodes: [HeadingNode, QuoteNode, ListNode, ListItemNode, LinkNode, CodeNode, DividerNode, CalloutNode, ButtonNode, ImageNode, VideoNode, AudioNode, FileNode, GalleryNode],
