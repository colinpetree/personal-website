...
import { ImageNode, VideoNode, AudioNode, FileNode, GalleryNode, DividerNode } from './nodes'
import {
  LoadHtmlPlugin,
  HtmlOutputPlugin,
...
const RichTextEditor = forwardRef(function RichTextEditor(
  ...
  const initialConfig = {
    ...
    theme,
    nodes: [HeadingNode, QuoteNode, ListNode, ListItemNode, LinkNode, CodeNode, DividerNode, ImageNode, VideoNode, AudioNode, FileNode, GalleryNode],
