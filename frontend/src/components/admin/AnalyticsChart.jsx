...
export default function AnalyticsChart({ series, metric = 'unique_visitors', label = 'Unique visitors' }) {
    ...
    <div className="h-64 w-full">
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={data} margin={{ top: 8, right: 12, bottom: 0, left: -12 }}>
          ...
          <YAxis allowDecimals={false} tick={{ fontSize: 11, fill: '#9ca3af' }} tickLine={false} axisLine={false} width={32} />
          <Tooltip
