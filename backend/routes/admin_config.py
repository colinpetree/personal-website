...
def update_admin_config():
    ...
    plain_fields = [
        ...
        'projects_enabled', 'projects_page_name', 'projects_text',
        'about_enabled', 'about_page_name', 'about_text', 'headshot_filename',
        'contact_enabled', 'contact_page_name',
        'smtp_host', 'smtp_port', 'smtp_user', 'smtp_from_email', 'smtp_sender_name', 'forward_email',
        'ai_demo_enabled', 'ai_demo_page_name',
        'donate_enabled', 'donate_page_name', 'stripe_publishable_key',
    ]
