...
8. **Vision / image input** — **upload → analysis UI**, not a chat. Visitor uploads/picks an image, sees Claude's analysis of it.
...
5. AI Implementations page — **in progress**: card grid + Conversation basics done (2026-07-31), 7 of 8 v1 cards now shipped (tool use, RAG, MCP, prompt evaluation, prompt engineering, web search), remaining card (vision) still to build, per §6 above.
